...
public class TmpCtSecBean implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	  ...
	  private String cirCode;
		...
		public TmpCtSecBean(String cirCode, String secCode, String secName, BigDecimal blTot, BigDecimal blCom,
				BigDecimal blPen, BigDecimal meTot, BigDecimal meCom, BigDecimal mePen, BigDecimal pfTot,
				BigDecimal pfCom, BigDecimal pfPen, BigDecimal vfTot, BigDecimal vfCom, BigDecimal vfPen,
				BigDecimal fiTot, BigDecimal fiCom, BigDecimal fiPen, BigDecimal thTot, BigDecimal thCom,
				BigDecimal thPen, BigDecimal teTot, BigDecimal teCom, BigDecimal tePen, BigDecimal csTot,
				BigDecimal csCom, BigDecimal csPen, BigDecimal otTot, BigDecimal otCom, BigDecimal otPen,
				String cirName, String regCode) {
			super();
			this.cirCode = cirCode;
			this.secCode = secCode;
			this.secName = secName;
